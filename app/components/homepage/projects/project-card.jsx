    ...
    <div className="glow-container glow-card from-[#0d1224] border-[#1b2c68a0] relative rounded-lg border bg-gradient-to-r to-[#0a0d37] w-full hover:shadow-2xl hover:shadow-pink-500/20 transition-all duration-300 transform hover:-translate-y-1">
      {images && images.length > 0 && (
        <div className="relative overflow-hidden rounded-t-lg">
          ...
          <div className="absolute inset-0 bg-gradient-to-t from-[#0d1224] to-transparent opacity-50"></div>
        </div>
      )}
      ...
      <div className="px-6 lg:px-10 py-4 lg:py-6 relative">
        ...
        <p className="text-center ml-3 text-[#16f2b3] text-lg lg:text-2xl font-bold">
          {project.name}
        </p>
      </div>
      ...
      <div className="px-6 lg:px-10 pb-6 flex flex-wrap gap-4">
        {project.code && (
          <a
            href={project.code}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center bg-gradient-to-r from-gray-700 to-gray-800 text-white font-semibold py-2 px-4 rounded-lg hover:from-gray-600 hover:to-gray-700 transition-all duration-300 hover:shadow-lg hover:shadow-gray-500/50"
          >
